 ...
 * @version        $Id: 1.0 update.php 1 Sun 2018-01-07 21:18:25Z XOOPS Project (www.xoops.org) $
 */
/**
 * @param      $module
 ...
 * @return bool|null
 */
function xoops_module_update_wgrealestate(&$module, $prev_version = null)
{
    // irmtfan bug fix: solve templates duplicate issue
    $ret = null;
    if ($prev_version < 10) {
        $ret = update_wgrealestate_v10($module);
    }
 ...
 * @return bool
 */
function update_wgrealestate_v10(&$module)
{
    global $xoopsDB;
